...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	 ...
	 * |    |  |   |   |   |   |   |   |Mut|Vo-|Vo+|   |       |PUp|    |
	 * |----------------------------------------------------------------|
	 * |Sleep|Reset|    |        F10         |     |Menu|  |Hom|PDn|End |
	 * `------------------------------------------------'  `------------'
	 */
	[_FN] = LAYOUT_65_iso(
		...
		_______,     _______, _______, KC_PGDN, _______, _______, KC_LEFT, KC_DOWN,  KC_UP, KC_RGHT, _______,  _______,  KC_END, _______, _______,
		_______,_______,_______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,       KC_PGUP, _______,
		KC_SLEP,  RESET,    _______,                KC_F10,                          _______,  XXXXXXX,   KC_APP,  KC_HOME,      KC_PGDN, KC_END
	),
};
